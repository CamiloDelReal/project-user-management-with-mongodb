package com.example.usermanagementwithmongodb.integrations;
import com.example.usermanagementwithmongodb.dtos.*;
import com.example.usermanagementwithmongodb.entities.Role;
import com.example.usermanagementwithmongodb.utils.CustomMongoDbContainer;
...
public class UserManagementControllerServerSideTests extends AbstractTestNGSpringContextTests {
    ...
    @Container
    public static final CustomMongoDbContainer mongoContainer;
    ...
    static {
        mongoContainer = new CustomMongoDbContainer("mongo:5.0.8", "username", "password", "users_database");
    ...
    public void createUserWithAdminRole_failByNoAdminCredentials() throws Exception {
        ...
        UserRequest userRequest = new UserRequest("Jane", "Doe", "janedoe@gmail.com", "qwerty", List.of(new RoleRequest(adminRole.getId())));
    ...
    public void createUserWithAdminRole_success() throws Exception {
        ...
        UserRequest userRequest = new UserRequest("Kath", "Doe", "kathdoe@gmail.com", "qwerty", List.of(new RoleRequest(adminRole.getId())));
    ...
    public void editUserToAdminWithUserCredentials_failByNoAdminCredentials() throws Exception {
        ...
        UserRequest userEditRequest = new UserRequest("Beth", "Doe", "bethdoe@gmail.com", "poiuy", List.of(new RoleRequest(adminRole.getId())));
